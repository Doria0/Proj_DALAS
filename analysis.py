...
print(df2.shape)
df2.to_csv('data_2020-2024.tsv',sep='\t',mode='a')
...
# print(has_box_office.shape) #82/9000,185/15000,311/20000,758/30000,1110/35000,1937/40000,2324/50000
